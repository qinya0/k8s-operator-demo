...
func (in *AppIng) DeepCopyInto(out *AppIng) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppIng.
func (in *AppIng) DeepCopy() *AppIng {
	if in == nil {
		return nil
	}
	out := new(AppIng)
...
func (in *AppServiceStatus) DeepCopyInto(out *AppServiceStatus) {
	*out = *in
	in.DeployStatus.DeepCopyInto(&out.DeployStatus)
	in.SvcStatus.DeepCopyInto(&out.SvcStatus)
	in.IngStatus.DeepCopyInto(&out.IngStatus)
}
